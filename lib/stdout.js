...
const style = {
    bold: styled('\u001b[1m'),
    yellow: styled('\u001b[1m\u001b[33m'),
    red: styled('\u001b[1m\u001b[31m'),
    green: styled('\u001b[1m\u001b[32m'),
    cyan: styled('\u001b[1m\u001b[36m'),
    magenta: styled('\u001b[1m\u001b[35m'),
    default: '\u001b[39m\u001b[22m'
};
...
function styled(color) {
    return function colored(...args) {
        return color + format(...args) + style.default;
    };
}
 ...
 */
function info(...args) {
    return console.log(style.green(...args));
}
 ...
 */
function warn(...args) {
    return console.warn(style.yellow(...args));
}
 ...
 */
function error(...args) {
    return console.error(style.red(...args));
}
